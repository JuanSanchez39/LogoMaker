...
describe('Circle', () => {
  describe('Letters Too Long', () => {
    test(' an error will show if letters input is more than three characters long', () => {
  ...
  describe('Letters Length', () => {
    test('an error will show  if letters input is less than three characters long', () => {
  ...
  describe('Render', () => {
    test('san error will show  if render() is called', () => {
      const circle = new Circle('AAA', 'White', 'Green');
